...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-secondary/50 relative">
      <div className="absolute inset-0 bg-gradient-to-t from-background to-secondary/30 opacity-90"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/2 lg:pr-8">
            <Card className="backdrop-blur-sm bg-background/60 border-border/50 shadow-xl h-full">
                ...
                <div className="space-y-8">
                  {contactInfo.map((item, index) => (
                    <div key={index} className="flex items-center group">
                      <div className="w-12 h-12 bg-accent/10 flex items-center justify-center rounded-xl mr-4 text-accent group-hover:bg-accent/20 transition-colors">
                        {item.icon}
                      </div>
                      <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Textarea
                      ...
                      required
                      rows={5}
                      className="bg-background/80 border-border resize-none min-h-[150px]"
